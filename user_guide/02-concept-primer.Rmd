...
+ LandUse (Bzone)
    ...
    + Developable area
    + Parking pricing policies (paid or not, costs, % of trips paying for parking, and cash-out as a share of workers paying for parking)
...
+ Parking restrictions (work and non-work) including paid parking (out of pocket) and cash-out parking TDM policies
...
Parking cash-out is an employee benefit supporting multimodal travel options. Under a monthly parking cash-out policy, employers that provide free or subsidized parking at work (i.e., a parking subsidy) would also offer employees the option to take an equivalent taxable cash payment instead of the monthly parking subsidy. Employees could convert all or a portion of that cash payment, tax free, to cover the fare for tax-advantaged eligible commute mode, like transit or vanpool. The cash-out is sometimes combined with discounted transit passes. The payment can also be used by the employee for paying the costs of other non SOV commute choices that are not tax advantaged such as walking or micromobility, for housing closer to work that is more expensive, or just to bolster income. Employees who are offered a monthly cash-out option may respond differently to those offered a more flexible daily option, with those offered the latter having higher take-up rates. FHWA has an [excellent primer on the topic](https://ops.fhwa.dot.gov/publications/fhwahop12026/sec_4.htm), while many consider Donald Shoup's [online book](http://shoup.bol.ucla.edu/Parking%20Cash%20Out%20Report.pdf) a definitive resource on the topic.

The share of users participating in the worker parking cash-out program is an explicit input to VisionEval (bzone_parking.csv for RSPM and marea_parking-cost_by_area-type.csv for VE-State ) and should reflect the actual uptake of the program. The participation rate inputs (share of workers who pay to park) are specified for Bzones for RSPM and can be differentiated by metropolitan area and area type (center, inner, outer) within metropolitan areas in VE-State. The VisionEval modules, CalculateVehicleOperatingCost and BudgetHouseholdDvmt, are designed to assess parking cash-out impacts on household income and driving budgets.

The VisionEval model is quite simple in its accounting of the cash-out policy. Once the participation rates are entered in the parking input file, it changes (increases) the annual household income to include the cash value of the parking subsidy. It is critical that if the cash-out input is used, a further adjustment to the <u>proportion of drivers paying to park at work</u> is needed to reflect the change in the number of recipients of parking cash-out will then pay for parking on a day-to-day basis when used. For instance, if the cash-out proportion increases and the share of those paying for parking does <u>not</u> increase, then household incomes will increase, and VMT is likely to increase. It is often the case, that there are more employees paying for parking than receiving cash-out payments in the base scenario. If the cash-out share increases during an alternative scenario, an equal share of employees paying for parking needs to also increase. There is no other policy or override in VisionEval that will force those drivers receiving cash-out to affect their driving behavior. 
...
Parking costs in VisionEval are trip-based costs, commonly paid for at one or both ends of a trip, and sometimes paid for on a monthly basis. The standard practice for handling parking pricing in urban travel demand models is to include it in the trip costs for auto travel. Two types of parking costs are addressed in the model - parking costs at places of employment and parking costs at other places. Daily parking costs are calculated for each household and added in with other variable costs.  This includes fees for parking at workplace (including cash-out policies) and for non-work trips. Cash-out policies are a travel demand management policy that allows employers who offer workplace parking to employees the cash value of the parking space to the worker if the worker uses other means to get to work (i.e., doesn't use the parking space). Parking fees are a subset of [parking restrictions](#parking-restrictions). Parking fees can be paid for residential, workplace, or other destinations.

### parking restrictions {#parking-restrictions}
Parking restrictions and fees affect households at their places of residence and work, as well as other places they travel to within the modeled area. This information is coded at the Bzone level and typically includes the average number of free parking spaces by dwelling unit type (single family, multi-family, and group quarters), the average daily parking cost, and proportion of workers who pay for parking, as well as the share of workers who participate in a cash out-buy back program. VisionEval treats this policy as if the worker is paying for parking and they receive a cash value of the parking space given they no longer use it. Parking restrictions are used for Azones that are members of a defined metropolitan area (Marea) within the model.
