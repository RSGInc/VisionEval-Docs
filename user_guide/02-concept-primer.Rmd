...
Parking cash-out is an employee benefit supporting multimodal travel options. Under a monthly parking cash-out policy, employers that provide free or subsidized parking at work would also offer employees the option to take an equivalent taxable cash payment instead of the monthly parking subsidy. Employees could convert all or a portion of that cash payment, tax free, to cover the fare for tax-advantaged eligible commute mode, like transit or vanpool.
The cash-out is sometimes combined with discounted transit passes, or is used an inducement to reduce commuting by auto, especially in single-occupant vehicles. It can also be used for defraying costs for commute choices that are not tax advantaged such as walking or micromobility, for housing closer to work that is more expensive, or just to bolster income.
