...
table <- data.frame(
  Geo = c("RVMPO", "RVMPO"),
  Year = c(2010, 2038),
  TransitVanFuelCI = c(90.38, 72.3),
  TransitBusFuelCI = c(NA, NA),
  TransitRailFuelCI = c(NA, NA))
  kable(table, align = c("l", rep("c", 4)))
```
...
table <- data.frame(
  Geo = c("RVMPO", "RVMPO"),
  Year = c(2010, 2038),
  HhFuelCI = c(90.23, 72.3),
  CarSvcFuelCI = c(90.23, 72.3),
  ComSvcFuelCI = c(90.23, 72.3),
  HvyTrkFuelCI = c(NA, NA),
  TransitVanFuelC = c(NA, NA),
  TransitBusFuelC = c(NA, NA),
  TransitRailFuel = c(NA, NA))
  kable(table, align = c("l", rep("c", 8)))
```
...
*  **CenterPropCashOut**: Proportion of workers that participate in a cash-out-buy-back program among those who also pay to park in the center area type
* **InnerPropCashOut**: Proportion of workers that participate in a cash-out-buy-back program among those who also pay to park in the inner area type

* **OuterPropCashOut**: Proportion of workers that participate in a cash-out-buy-back program among those who also pay to park in the outer area type
