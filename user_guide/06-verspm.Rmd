...
The iterative process to balance the VMT with travel costs allows congestion and other costs introduced at this step influence the amount of travel. This step balances the amount of household travel with the cost of travel and recalculates household VMT and Fuel in the process. The primary outputs of the RSPM are household travel and fuel and power consumption but other information is produced for households and commercial vehicles as well. The amount of commercial (light‐duty) and freight (heavy duty) travel is calculated as well as associated fuel and power consumption for those vehicles.
...
The following two modules calculate heavy vehicle fuel and power consumption: 
...
table <- data.frame(
  ...
  Year = c(2010, 2038),
  GrpAge0to14 = c(0, 0),
  GrpAge15to19 = c(666, 666),
  GrpAge20to29 = c(382, 382),
  GrpAge30to54 = c(66, 66),
  GrpAge55to64 = c(7, 7),
  GrpAge65Plus = c(0,0))
kable(table) %>%
  kable_styling() %>%
...
table <- data.frame(
  Geo = c("RVMPO", "RVMPO"),
  Year = c(2010, 2038),
  HHIncomePC.2010 = c(32164, 43334),
  GQIncomePC.2010 = c(7500, 10000))
kable(table, align = c("l", rep("c", 3)))
```
#### Internal Module Inputs {-}
...
```{r}
table <- data.frame(
  Geo = c("D410290014002", "D410290013012", "D410290014001", "D410290014003", "D410290013021"),
  Year = c(2010, 2010, 2010, 2010, 2010),
  SFDU = c(559, 79, 1398, 1385, 271),
  MFDU = c(0, 8, 180, 172, 0),
  GQDU = c(0, 523, 0, 0, 0))
kable(table, align = c("l", rep("c", 4)))
```
...
table <- data.frame(
  Geo = c("D410290014002", "D410290013012", "D410290014001", "D410290014003", "D410290013021"),
  Year = c(2010, 2010, 2010, 2010, 2010),
  HhPropIncQ1 = c(0.12, 0, 0.24, 0.16, 0.29),
  HhPropIncQ2 = c(0.54, 0.32, 0.16, 0.19, 0.29),
  HhPropIncQ3 = c(0.26, 0.36, 0.26, 0.36, 0.15),
  HhPropIncQ4 = c(0.54, 0.32, 0.16, 0.19, 0.29))
kable(table, align = c("l", rep("c", 5)))
```
...
table <- data.frame(
  Geo = c("D410290014002", "D410290013012", "D410290014001", "D410290014003", "D410290013021"),
  Year = c(2010, 2010, 2010, 2010, 2010),
  TotEmp = c(403, 1382, 271, 609, 49),
  RetEmp = c(262, 73, 12, 66, 1),
  SvcEmp = c(96, 880, 172, 413, 41))
kable(table, align = c("l", rep("c", 4)))
```
...
table <- data.frame(
  Geo = c("D410290014002", "D410290013012", "D410290014001", "D410290014003", "D410290013021"),
  Year = c(2010, 2010, 2010, 2010, 2010),
  Latitude = c(42.4865735, 42.4425881, 42.4601016, 42.4767348, 42.3730446),
  Longitude = c(-122.8013868, -122.8461128, -122.7924738, -122.8007913, -122.7793008))
kable(table, align = c("l", rep("c", 3)))
```
...
table <- data.frame(
  Geo = c("D410290014002", "D410290013012", "D410290014001", "D410290014003", "D410290013021"),
  Year = c(2010, 2010, 2010, 2010, 2010),
  PropUrbanSFDU = c(0.468694097, 0.886075949, 0.862660944, 0.990613718, 0.014760148),
  PropUrbanMFDU = c(1, 1, 1, 1, 1),
  PropUrbanGQDU = c(1, 1, 1, 1, 1),
  PropTownSFDU = c(0, 0, 0, 0, 0), 
  PropTownMFDU = c(0, 0, 0, 0, 0),
  PropTownGQDU = c(0, 0, 0, 0, 0))
...
table <- data.frame(
  Geo = c("D410290014002", "D410290013012", "D410290014001", "D410290014003", "D410290013021"),
  Year = c(2010, 2010, 2010, 2010, 2010),
  UrbanArea = c(298.6487137, 830.600945, 983.1506646, 439.2145619, 0.354854836),
  TownArea = c(0, 0, 0, 0, 0),
  RuralArea = c(4996.118763, 384.8092231, 3699.940171, 90.86259214, 6212.576395))
  kable(table, align = c("l", rep("c", 4)))
```
...
table <- data.frame(
  Geo = c("D410290014002", "D410290013012", "D410290014001", "D410290014003", "D410290013021"),
  Year = c(2010, 2010, 2010, 2010, 2010),
  D3bpo4 = c(0.261875689, 0.483090076, 1.803813028, 18.97663013, 0.101303887))
  kable(table, align = c("l", rep("c", 2)))
```
...
* **PropCashOut**: Proportion of workers that participate in a cash-out-buy-back program among those who also pay to park
...
table <- data.frame(
  Geo = c("D410290014002", "D410290013012", "D410290014001", "D410290014003", "D410290013021"),
  Year = c(2010, 2010, 2010, 2010, 2010),
  PkgSpacesPerSFDU = c(3, 4, 4, 4, 4),
  PkgSpacesPerMFDU = c(1.5, 4, 4, 4, 4),
  PkgSpacesPerGQ = c(0, 0, 0, 0, 0),
  PropWkrPay = c(0, 0, 0, 0, 0),
  PropCashOut = c(0, 0, 0, 0, 0),
  PkgCost.2010 = c(0, 0, 0, 0, 0))
  kable(table, align = c("l", rep("c", 7)))
```
...
table <- data.frame(
  Geo = c("D410290014002", "D410290013012", "D410290014001", "D410290014003", "D410290013021"),
  Year = c(2010, 2010, 2010, 2010, 2010),
  EcoProp = c(0, 0.2, 0.2, 0, 0),
  ImpProp = c(0, 0.4, 0.4, 0, 0))
  kable(table, align = c("l", rep("c", 3)))
```
...
table <- data.frame(
  Geo = c("D410290014002", "D410290013012", "D410290014001", "D410290014003", "D410290013021"),
  Year = c(2010, 2010, 2010, 2010, 2010),
  CarSvcLevel = c("Low", "Low", "Low", "Low", "Low"))
  kable(table, align = c("l", rep("c", 2)))
```
...
table <- data.frame(
  Geo = c("RVMPO", "RVMPO"),
  Year = c(2010, 2038),
  DRRevMi = c(382639, 2381995),
  VPRevMi = c(0, 0),
  MBRevMi = c(607922, 3580237),
  RBRevMi = c(0, 0),
  MGRevMi = c(0, 0),
  SRRevMi = c(0, 0),
  HRRevMi = c(0, 0),
  CRRevMi = c(0, 0))
  kable(table, align = c("l", rep("c", 9)))
```
...
table <- data.frame(
  Year = c(2010, 2038),
  DrvPerPrsn15to19 = c(0.817460922, 0.909183957), 
  Drv20to29AdjProp = c(0.94664472, 0.909183957),
  Drv30to54AdjProp = c(0.94664472, 0.909183957),
  Drv55to64AdjProp = c(0.99, 0.950823576),
  Drv65PlusAdjProp = c(0.934995118, 0.897995355))
  kable(table, align = c("l", rep("c", 5)))
```
...
- **HighCarSvcCost**: Average cost in dollars per mile for travel by high service level car service exclusive of the cost of fuel, and road use taxes.
- **LowCarSvcCost**: Average cost in dollars per mile for travel by low service level car service exclusive of the cost of fuel and road use taxes.
...
table <- data.frame(
  Geo = c("RVMPO", "RVMPO"),
  Year = c(2010, 2038),
  AutoMeanAge = c(10.8, 12),
  LtTrkMeanAge =c(10.5, 12))
  kable(table, align = c("l", rep("c", 3)))
```
...
table <- data.frame(
  Geo = c("RVMPO", "RVMPO"),
  Year = c(2010, 2038),
  VehOwnFlatRateFee.2015 = c(50, 0),
  VehOwnAdValoremTax = c(0, 0.01))
  kable(table, align = c("l", rep("c", 3)))
```
...
table <- data.frame(
  Geo = c("RVMPO", "RVMPO"),
  Year = c(2010, 2038),
  PropSovDvmtDiverted = c(0.04, 0.8))
  kable(table, align = c("l", rep("c", 2)))
```
...
table <- data.frame(
  Geo = c("RVMPO", "RVMPO"),
  Year = c(2010, 2038),
  TransitEthanolPropGasoline = c(0.1, 0.1),
  TransitBiodieselPropDiesel = c(0.05, 0.05),
  TransitRngPropCng = c(0, 0))
  kable(table, align = c("l", rep("c", 4)))
```
...
table <- data.frame(
  ...
  Year = c(2010, 2038),
  VanPropDiesel = c(0, 0),
  VanPropGasoline  = c(1, 1),
  VanPropCng = c(0, 0),
  BusPropDiesel = c(0.2, 0.2),
  BusPropGasoline = c(0, 0),
  BusPropCng = c(0.8, 0.8),
  RailPropDiesel = c(1, 1),
  RailPropGasoline = c(0, 0))
  kable(table, align = c("l", rep("c", 9)))
```
...
table <- data.frame(
  Geo = c("RVMPO", "RVMPO"),
  Year = c(2010, 2038),
  CarSvcAutoPropIcev = c(0.99, 0.441), 
  CarSvcAutoPropHev = c(0.01, 0.528),
  CarSvcAutoPropBev = c(0, 0.031),
  CarSvcLtTrkPropIce = c(1, 0.5335),
  CarSvcLtTrkPropHev = c(0, 0.4572),
  CarSvcLtTrkPropBev = c(0, 0.0093))
  kable(table, align = c("l", rep("c", 7)))
```
...
table <- data.frame(
  Geo = c("RVMPO", "RVMPO"),
  Year = c(2010, 2038),
  ComSvcAutoPropIcev = c(0.99, 0.441), 
  ComSvcAutoPropHev = c(0.01, 0.528),
  ComSvcAutoPropBev = c(0, 0.031),
  ComSvcLtTrkPropIcev = c(1, 0.5335),
  ComSvcLtTrkPropHev = c(0, 0.4572),
  ComSvcLtTrkPropBev = c(0, 0.0093))
  kable(table, align = c("l", rep("c", 7)))
```
...
table <- data.frame(
  Geo = c("RVMPO", "RVMPO"),
  Year = c(2010, 2038),
  HvyTrkPropIcev = c(1, 0.4),
  HvyTrkPropHev = c(0, 0.4),
  HvyTrkPropBev = c(0, 0.2))
  kable(table, align = c("l", rep("c", 4)))
```
...
table <- data.frame(
  Geo = c("RVMPO", "RVMPO"),
  Year = c(2010, 2038),
  PropSFChargingAvail = c(1, 1), 
  PropMFChargingAvail = c(0, 0.2),
  PropGQChargingAvail = c(0, 0))
  kable(table, align = c("l", rep("c", 4)))
```
...
table <- data.frame(
  StateAbbrLookup = c(""),
  HvyTrkDvmtGrowthBasis = c("Income"),
  HvyTrkDvmt = c(NA),
  ComSvcDvmtGrowthBasis = c("Population"))
  kable(table, align = c("l", rep("c", 3)))
```
...
table <- data.frame(
  Geo = c("RVMPO"),
  UzaNameLookup = c("Medford/OR"),
  UrbanLdvDvmt = c(NA), 
  UrbanHvyTrkDvmt = c(NA))
  kable(table, align = c("l", rep("c", 3)))
```
...
table <- data.frame(
  Geo = c("RVMPO"),
  LdvFwyDvmtProp = c(0.2632296),
  LdvArtDvmtProp = c(0.47739), 
  LdvOthDvmtProp = c(0.2593804),
  HvyTrkFwyDvmtProp = c(""),
  HvyTrkArtDvmtProp = c(""),
  HvyTrkOthDvmtProp = c(""),
  BusFwyDvmtProp = c(0),
  BusArtDvmtProp = c(0.69629864),
  BusOthDvmtProp = c(0.30370136))
  kable(table, align = c("l", rep("c", 9)))
```
...
table <- data.frame(
  Geo = c("RVMPO"),
  Year = c("2010", "2038"),
  RampMeterDeployProp = c(0, 0.95),
  IncidentMgtDeployProp = c(0.5, 0.95),
  SignalCoordDeployProp = c(0.5, 0.95),
  AccessMgtDeployProp = c(0, 0.24),
  OtherFwyOpsDeployProp = c(0, 0),
  OtherArtOpsDeployProp = c(0, 0))
  kable(table, align = c("l", rep("c", 7)))
```
...
```{r}
table <- data.frame(
  Level = c("None", "Mod", "Hvy", "sev", "Ext"),
  Art_Rcr = c(0, 0, 0, 0, 0),
  Art_NonRcr = c(0, 0, 0, 0, 0),
  Fwy_Rcr = c(0, 0, 0, 0, 0),
  Fwy_NonRcr = c(0, 0, 0, 0, 0),
  AccessMgtDeployProp = c(0, 0, 0, 0, 0),
  OtherFwyOpsDeployProp = c(0, 0, 0, 0, 0),
  OtherArtOpsDeployProp = c(0, 0, 0, 0, 0))
  kable(table, align = c("l", rep("c", 7)))
```
...
table <- data.frame(
  Geo = c("RVMPO"),
  Year = c("2010", "2038"),
  FwyNoneCongChg.2010 = c(0, 0),
  FwyModCongChg.2010= c(0, 0),
  FwyHvyCongChg.2010= c(0, 0),
  FwySevCongChg.2010= c(0, 0.1),
  FwyExtCongChg.2010= c(0, 0.2),
  ArtNoneCongChg.2010= c(0, 0),
  ArtModCongChg.2010= c(0, 0),
  ArtHvyCongChg.2010= c(0, 0),
  ArtSevCongChg.2010= c(0, 0),
  ArtExtCongChg.2010= c(0, 0))
...
| VEPowertrainsAndFuels          | [AssignHhVehiclePowertrain](#verspm-assignhhvehiclepowertrain)     |**KWHPM**  | Average kilowatt-hours per mile of vehicle travel powered by electricity                 |
| VEPowertrainsAndFuels          | [AssignHhVehiclePowertrain](#verspm-assignhhvehiclepowertrain)     |**ElecDvmtProp**  | Average miles of vehicle travel per gasoline equivalent gallon (fuel and electric powered)                |
 per mile of travel powered by electricity |
| VEHouseholdVehicles    | [CalculateVehicleOwnCost ](#verspm-calculatevehicleowncost ) |**InsCost**      |  Annual vehicle insurance cost in dollars                       |
...
This module calculates the energy consumption of heavy trucks and light-duty commercial service vehicles. It does not calculate the values for car service vehicles which are calculated as part of the household emissions. It also does not calculate public transit emissions which are calculated in the CalculateTransitEnergyAndEmissions module.
...
This module calculates the energy consumption of public transit vehicle emissions in urbanized areas.
