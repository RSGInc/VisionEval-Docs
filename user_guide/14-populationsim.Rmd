...
- This process requires the VisionEval is setup with an identical geography as the population data. Alert! - This may not be a trivial task.
...
The following describes the process summarized below:
...
- Revised VisionEval run scripts to run the amended process that excludes the VisionEval SimHouseholds module.

***Note (to be removed when Task 5 is complete) : Task 5.2 sets out the model design for this process. Task 5.3 is designing the working prototype for this process.***
